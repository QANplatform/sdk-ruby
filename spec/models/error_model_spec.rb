...
# Unit tests for OpenapiClient::ErrorModel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ErrorModel do
  let(:instance) { OpenapiClient::ErrorModel.new }

  describe 'test an instance of ErrorModel' do
    it 'should create an instance of ErrorModel' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ErrorModel)
    end
  end
